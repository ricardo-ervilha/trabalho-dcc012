...
myapps_bin:
	g++ .$(PS)apps$(PS)main_bin.cpp .$(PS)obj$(PS)List.o .$(PS)obj$(PS)File.o .$(PS)obj$(PS)ProductReview.o .$(PS)obj$(PS)Hash.o .$(PS)obj$(PS)BucketSort.o .$(PS)obj$(PS)MergeSort.o .$(PS)obj$(PS)HashProduct.o  -I .$(PS)include -o .$(PS)bin$(PS)main_bin
